...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'stairs':
				tex = Paths.getSparrowAtlas('characters/Stairs','shared');
				frames = tex;
				...
				animation.addByPrefix('lol', 'Crystalded', 24, false);
			...
			case 'crystal':
				...
				frames = tex;
				animation.addByPrefix('idle', 'crystalidle', 24, false);
				animation.addByPrefix('fuckingdeadlol', 'crystalde', 24, false);
